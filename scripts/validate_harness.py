...
COMPONENTS = {
    ...
    "application_resume_artifact_sync_contract": "contracts/application-resume-artifact-sync.v1.json",
    "application_resume_artifact_sync_positive_fixture": "fixtures/application-resume-artifact-sync/01-durable-ready-positive.json",
    ...
    "repository_promotion_contract": "contracts/repository-promotion.v1.json",
    "promotion_guard": "scripts/promotion_guard.py",
    "repository_promotion_validator": "scripts/validate_repository_promotion.py",
    "promotion_workflow": ".github/workflows/promotion.yml",
...
REQUIRED_REGISTRY = {
    ...
    "Repository promotion contract": "contracts/repository-promotion.v1.json",
    "Promotion guard": "scripts/promotion_guard.py",
    "Repository promotion validator": "scripts/validate_repository_promotion.py",
    "Promotion tests": "tests/test_repository_promotion.py",
    "Promotion workflow": ".github/workflows/promotion.yml",
}
...
def validate_hooks() -> None:
    ...
    for path, text in ((".githooks/pre-commit",pre),(".githooks/pre-push",push)):
        ...
        for token in ("python scripts/validate_governance.py","python scripts/validate_product_version.py","python scripts/validate_repository_promotion.py","python scripts/validate_harness.py"):
...
def validate_ci() -> None:
    ...
    promo = read(".github/workflows/promotion.yml")
    for marker in ("name: Repository Promotion","pull_request:","merge_group:","workflow_dispatch:","concurrency:","promotion-guard","expected_head_sha","PROVIDER_UNAVAILABLE","gh api"):
        if marker not in promo:
            raise HarnessError(f"promotion CI missing marker: {marker}")
...
def main() -> int:
    ...
    print("repository_promotion_validator=PASS")
