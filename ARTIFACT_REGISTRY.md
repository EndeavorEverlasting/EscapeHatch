...
| Generated application-assist distribution | `Outputs/application-assist/` | generated distributable extension/package artifacts | `browser/application-assist` build output; single canonical generated-output root, never an alternate source of truth | manual inspection; `docs/APPLICATION_ASSIST_SESSION.md` path hygiene note |
